...
import { getTakeAndSkip } from '@/shared/utils/get-take-and-skip';
import { ICreateGymDTO } from '@/modules/gyms/dtos/create-gym-dto';
import { IFindManyNearbyDTO } from '../../dtos/find-many-nearby-dto';
import { NEARBY_DISTANCE_IN_KILOMETERS } from '@/shared/utils/constants';
